...
class affiliation(commands.Cog):
    ...
    async def on_message(self, ctx):
        ...
        if ctx.channel.id == 1005388870709432320:
...
def get_aliexpress_affiliate_link(url):
    ...
    return "Desolé, cette fonctionnalité n'est pas encore disponible.\nPour obtenir un lien d'affiliation aliexpress vous pouvez mentionner Bricolage c'est cool"
